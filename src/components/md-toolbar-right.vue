<template>
      <div class="v-right-item">
        ...
        <button type="button" v-if="toolbars.navigation" @click="$clicks('navigation')" v-show="!s_navigation"
                ...
                aria-hidden="true" :title="`${d_words.tl_navigation_on} (F8)`"><span style="display:flex">导航</span></button>
        <button type="button" v-if="toolbars.navigation" @click="$clicks('navigation')" v-show="s_navigation"
                class="op-icon fa fa-mavon-bars selected"
                aria-hidden="true" :title="`${d_words.tl_navigation_off} (F8)`"><span style="display:flex">导航</span></button>
        <button type="button" v-if="toolbars.preview" @click="$clicks('preview')" v-show="s_preview_switch"
                ...
                aria-hidden="true" :title="`${d_words.tl_edit} (F9)`"><span style="display:flex">编辑</span></button>
        <button type="button" v-if="toolbars.preview" @click="$clicks('preview')" v-show="!s_preview_switch"
                class="op-icon fa fa-mavon-eye"
                aria-hidden="true" :title="`${d_words.tl_preview} (F9)`"><span style="display:flex">编辑</span></button>
        <button type="button" v-if="toolbars.fullscreen" @click="$clicks('fullscreen')" v-show="!s_fullScreen"
                ...
                :title="`${d_words.tl_fullscreen_on} (F10)`" aria-hidden="true"><span style="display:flex">全屏编辑</span></button>
        <button type="button" v-if="toolbars.fullscreen" @click="$clicks('fullscreen')" v-show="s_fullScreen"
                class="op-icon fa fa-mavon-compress selected"
                :title="`${d_words.tl_fullscreen_off} (F10)`" aria-hidden="true"><span style="display:flex">全屏编辑</span></button>
        <button type="button" v-if="toolbars.readmodel" @click="$clicks('read')" class="op-icon fa fa-mavon-window-maximize" aria-hidden="true"
                :title="`${d_words.tl_read} (F11)`"><span style="display:flex">沉浸阅读</span></button>
        <button type="button" v-if="toolbars.subfield" @click="$clicks('subfield')" class="op-icon fa fa-mavon-columns" aria-hidden="true"
                :class = "{'selected': s_subfield}" :title="`${s_subfield ? d_words.tl_single_column : d_words.tl_double_column} (F12)`"><span style="display:flex">单栏</span></button>
        <span
        ...
        <button type="button" v-if="toolbars.htmlcode" @click="$clicks('html')" v-show="!s_html_code" class="op-icon fa fa-mavon-code"
                ...
                aria-hidden="true"><span style="display:flex">html</span></button>
        <button type="button" v-if="toolbars.htmlcode" @click="$clicks('html')" v-show="s_html_code"
                class="op-icon fa fa-mavon-code selected"
                :title="d_words.tl_html_off" aria-hidden="true"><span style="display:flex">html</span></button>
        <button type="button"  v-if="toolbars.help" @click="$clicks('help')" class="op-icon fa fa-mavon-question-circle"
                 ...
                 :title="d_words.tl_help" aria-hidden="true"><span style="display:flex">帮助</span></button>
