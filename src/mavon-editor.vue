<template>
    <div>
        ...
        <div class="v-note-panel">
            <!--编辑区-->
            <div id="edit" ref="vNoteEdit" @scroll="$v_edit_scroll" class="v-note-edit divarea-wrapper"
                 ...
                 @click="textAreaFocus" @input="$v_edit_scroll">
...
import '../resources/markdown/github-markdown.min.css'
export default {
    mixins: [markdown],
    props: {
        ...
        return {
            ...
            s_external_link: {
                markdown_css: function() {
                    ...
                    //return '~/resources/markdown/github-markdown.min.css'
                },
                hljs_js: function() {
